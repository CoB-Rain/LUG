USE [master]
GO
/****** Object:  Database [BASE]    Script Date: 02/10/2025 20:42:39 ******/
...
USE [BASE]
GO
/****** Object:  Table [dbo].[SEXO]    Script Date: 02/10/2025 20:42:39 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[USUARIO]    Script Date: 02/10/2025 20:42:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[USUARIO] ([ID], [NOMBRE], [CONTRASEÑA], [ID_SEXO]) VALUES (1, N'Christian', N'123', 2)
GO
ALTER TABLE [dbo].[USUARIO]  WITH CHECK ADD  CONSTRAINT [FK_USUARIO_SEXO] FOREIGN KEY([ID_SEXO])
