USE [master]
GO
/****** Object:  Database [BASE]    Script Date: 23/10/2024 21:24:05 ******/
...
USE [BASE]
GO
/****** Object:  Table [dbo].[BITACORA]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[CREDENCIAL]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[bitacora_borrar]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[bitacora_borrar]
as

	delete from bitacora

GO
/****** Object:  StoredProcedure [dbo].[bitacora_insertar]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

create proc [dbo].[bitacora_insertar]
@desc varchar(50), @fecha numeric
as
begin
	declare @id int
	set @id = (select ISNULL(max(id),0) +1 from BITACORA)

	insert into bitacora values (@fecha,@desc,@id)
end
GO
/****** Object:  StoredProcedure [dbo].[bitacora_Leer]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
create proc [dbo].[bitacora_Leer]
as

	select * from bitacora
GO
/****** Object:  StoredProcedure [dbo].[usuario_insertar]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
as 
BEGIN
insert into credencial values (@desc)
end

GO
/****** Object:  StoredProcedure [dbo].[usuario_listar]    Script Date: 23/10/2024 21:24:05 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
